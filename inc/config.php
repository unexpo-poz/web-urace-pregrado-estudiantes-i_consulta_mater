...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/i_consulta_mater/';
$urlDelSitio		= 'http://www.poz.unexpo.edu.ve/web/urace';

$lapsoProceso		= '2023-1I';

$tLapso				= ' Lapso Intensivo '.$lapsoProceso;
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/consulta_mater/cons_planillas_int_'.$lapsoProceso.'.log';
$inscHabilitada		= false;
$modoInscripcion	= '1'; // 1: Inscripcion, 2: Inclusion y Retiro

if ($modoInscripcion == '1'){
	$tProceso	= 'Consulta de Materias Inscritas ';
}
