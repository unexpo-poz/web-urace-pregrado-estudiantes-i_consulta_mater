...
if ($inscHabilitada){
	...
	print <<<x001
		...
		Disculpe, el m&oacute;dulo est&aacute; en mantenimiento.<br><br>
		</div><br>
x001
;
}
...
?>		
  <tr>
      ...
      <form method="post" name="chequeo" onSubmit="return validar(this)" action="planilla_i.php" target="planillab">
